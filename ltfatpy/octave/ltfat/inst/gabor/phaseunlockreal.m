...
%-*- texinfo -*-
%@deftypefn {Function} phaseunlockreal
%@verbatim
...
%     
%@end verbatim
%@strong{Url}: @url{http://ltfat.github.io/doc/gabor/phaseunlockreal.html}
%@seealso{dgt, phaselockreal}
%@end deftypefn
...
%   AUTHOR:    Peter Balazs, Peter L. Soendergaard, Zdenek Prusa
%   TESTING:   OK
%   REFERENCE: OK
