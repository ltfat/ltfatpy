function [s, err_mse, iter_time]=greed_omp_pinv(x,A,m,varargin)
%-*- texinfo -*-
%@deftypefn {Function} greed_omp_pinv
%@verbatim
...
%@end verbatim
%@strong{Url}: @url{http://ltfat.github.io/doc/thirdparty/sparsify/private/greed_omp_pinv.html}
%@end deftypefn
