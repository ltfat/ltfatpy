function [s, err_mse, iter_time]=greed_omp_linsolve(x,A,m,varargin)
%-*- texinfo -*-
%@deftypefn {Function} greed_omp_linsolve
%@verbatim
...
%@end verbatim
%@strong{Url}: @url{http://ltfat.github.io/doc/thirdparty/sparsify/private/greed_omp_linsolve.html}
%@end deftypefn
