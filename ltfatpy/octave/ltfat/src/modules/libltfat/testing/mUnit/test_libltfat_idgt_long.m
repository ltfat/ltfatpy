...
%-*- texinfo -*-
%@deftypefn {Function} test_libltfat_idgt_long
%@verbatim
%@end verbatim
%@strong{Url}: @url{http://ltfat.github.io/doc/libltfat/modules/libltfat/testing/mUnit/test_libltfat_idgt_long.html}
%@end deftypefn
