function test_failed = test_libltfat_long2fir(varargin)
test_failed = 0;
...
%-*- texinfo -*-
%@deftypefn {Function} test_libltfat_long2fir
%@verbatim
%@end verbatim
%@strong{Url}: @url{http://ltfat.github.io/doc/libltfat/modules/libltfat/testing/mUnit/test_libltfat_long2fir.html}
%@end deftypefn
