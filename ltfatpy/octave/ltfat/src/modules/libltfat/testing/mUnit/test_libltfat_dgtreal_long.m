...
%-*- texinfo -*-
%@deftypefn {Function} test_libltfat_dgtreal_long
%@verbatim
%@end verbatim
%@strong{Url}: @url{http://ltfat.github.io/doc/libltfat/modules/libltfat/testing/mUnit/test_libltfat_dgtreal_long.html}
%@end deftypefn
