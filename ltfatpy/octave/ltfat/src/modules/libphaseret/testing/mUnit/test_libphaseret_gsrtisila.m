...
%-*- texinfo -*-
%@deftypefn {Function} test_libphaseret_gsrtisila
%@verbatim
%@end verbatim
%@strong{Url}: @url{http://ltfat.github.io/doc/libltfat/modules/libphaseret/testing/mUnit/test_libphaseret_gsrtisila.html}
%@end deftypefn
